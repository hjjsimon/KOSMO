...
<body>
    ...
    <div class="container" style="margin-top:50px">
        ...
        <fieldset class="form-group border p-3">
        	<legend class="w-auto px-3">어플리케이션 영역에 저장된 속성 읽기</legend>
        	<h2>리스트 계열 컬렉션</h2><!-- 주로 컬렉션으로 만듦 -->
        	<ul class="list-unstyled">
        		<% 
        			List<MemberDTO> list = (List<MemberDTO>)application.getAttribute("list");//object꺼냄, ()써서 List로 형변환
	        		for(MemberDTO member : list){
        		%>
        		<li><%=member %></li><!-- toString해놨음, 그냥 찍으면 됨 -->
        		<% } %>
        	</ul>
        	<h2>맵 계열 컬렉션</h2><!-- 주로 컬렉션으로 만듦 -->
        	<ul class="list-unstyled">
        		<%
