    ...
    <div class="container" style="margin-top:50px">
        ...
        <fieldset class="form-group border p-3">
	  		...
	  		<form class="form-inline" action="ForwardNRedirectProcess.jsp" method="post">
				<label>아이디</label> <input class="form-control mx-2 mt-2" type="text" 
					name="id" value="<%=request.getParameter("id")==null?"":request.getParameter("id")%>"/>
					<!-- request 써서 아이디 비밀번호 입력값 유지시켜줌 -->
				<label>비밀번호</label> <input class="form-control mx-2 mt-2" type="password" 
					name="pwd" value="<%=request.getParameter("pwd")==null?"":request.getParameter("pwd")%>"/>
				<input class="btn btn-info ml-2 mt-2" type="submit" value="로그인" />
			</form>
			<span class="text-danger font-weight-bold">
				<%=request.getAttribute("errorMsg")==null?"":request.getAttribute("errorMsg") %></span>
				<!-- process에서 받은 메세지 null인지 확인해야함, process에 저장되어있음 -->
	  	</fieldset>
