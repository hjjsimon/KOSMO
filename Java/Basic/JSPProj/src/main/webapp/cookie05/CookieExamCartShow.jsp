...
<body>
    ...
    <div class="container" style="margin-top:50px">
        ...
        <fieldset class="form-group border p-3">
        	<legend class="w-auto px-3">장바구니에 담은 상품들</legend>
	        		...
	        		if(cookies != null){//쿠키는 꼭 null체크
	        			for(Cookie cookie : cookies){
	        				...
	        				if(value.toUpperCase().startsWith("PC_FR"))
	        					out.println(String.format("<li>%s</li>",URLDecoder.decode(name,"UTF-8")));
	        				//쿠키 중 product로 시작하는거 골라야함, 그리고 선택된것만 cart에 담음
	        			}
	        		}
        	...
        	<a href="CookieExamIndex.jsp">계속 쇼핑</a>
        </fieldset>        
