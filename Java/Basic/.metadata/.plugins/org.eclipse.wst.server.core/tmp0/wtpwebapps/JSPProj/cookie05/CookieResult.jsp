...
<body>
    ...
    <div class="container" style="margin-top:50px">
        ...
        <fieldset class="form-group border p-3">
        	<legend class="w-auto px-3">쿠키값 확인</legend>
        	<ul class="list-unstyled">
        		<%
        			Cookie[] cookies = request.getCookies();//요청헤더의 값을 읽어옴, 쿠키 배열
        			if(cookies != null){//쿠키는 null체크 필수, 안올수도 있음
        				for(Cookie cook : cookies){
        					//쿠키명 얻기
        					String name = cook.getName();
        					//쿠키값 얻기
        					String value = cook.getValue();
        					out.println(String.format("<li>%s : %s</li>",name,value));//쿠키명, 쿠키값
        					//userID는 index에서 굽는 쿠키라 안나옴(브라우저 끄면 userID삭제됨)
        					//JSESSIONID는 톰캣이 굽는 쿠키
        				}
        			}
        		%>
